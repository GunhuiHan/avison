...
class CommonProgramDetailPage extends StatefulWidget {
  final DocumentSnapshot doc;
  CommonProgramDetailPage(this.doc);
  @override
  _CommonProgramDetailPageState createState() =>
      _CommonProgramDetailPageState();
}

class _CommonProgramDetailPageState extends State<CommonProgramDetailPage>
        ...
        slivers: <Widget>[
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              child: Hero(
                tag: widget.doc['title'],
                child: Image.asset(
                  'assets/program/RC${widget.doc['id']}.png',
                  fit: BoxFit.fill,
                ),
              ),
            )),
        ...
        children: <Widget>[
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: programTime(widget.doc['time']),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(bottom: 8.0),
                        child: programLocation(widget.doc['location']),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(bottom: 8.0),
                        child: programPersonnel(widget.doc['personnel']),
                      ),
                      programGoogleForm(widget.doc['googleform']),
                      SizedBox(
                        height: 50,
                      )
                    ],
          ...
          currentTab ??
              Padding(
                ...
                child: Column(
                  children: <Widget>[
                    Text(widget.doc['intro'], style: TextStyle(fontSize: 14)),
                    SizedBox(
                      height: 50,
                    )
                  ],
